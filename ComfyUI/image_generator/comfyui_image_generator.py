...
# Add the parent directory to the path to import AssetManager
...
class ComfyUIImageGenerator:
    ...
    def __init__(self, 
        ...
        # Initialize asset manager for centralized storage
    ...
    def _create_workflow(self, request: GenerationRequest) -> Dict[str, Any]:
        ...
        if hasattr(request, 'model') and request.model:
            ...
            # Use default model
            workflow['1']['inputs']['ckpt_name'] = "v1-5-pruned-emaonly-fp16.safetensors"
    ...
    def save_images(self, result: GenerationResult) -> List[str]:
        """
        Save generated images to the centralized asset management system.
        ...
        """
        return save_result_images(result, self.asset_manager)
...
def save_result_images(result: GenerationResult, asset_manager: AssetManager = None):
    """
    Save generated images from a result to the centralized asset management system.
    
    Args:
        result: GenerationResult containing the images to save
        asset_manager: AssetManager instance (optional, will create one if not provided)
    """
    ...
    for i, image in enumerate(result.images):
        ...
        output_dir = asset_manager.get_asset_path('comfyui', 'outputs', '')
        ...
        # Register the asset in the asset management system
        metadata = {
        ...
        # Register the asset
        asset_manager.register_asset('comfyui', 'outputs', filename, filepath, metadata)
        
        saved_paths.append(filepath)
        print(f"✅ Saved and registered image: {filepath}")
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="ComfyUI Image Generator with Asset Management",
...
Examples:
  ...
  python comfyui_image_generator.py "Portrait of a person" --negative-prompt "blurry, low quality" --seed 42
    ...
    parser.add_argument(
        ...
        help='Model checkpoint name (default: v1-5-pruned-emaonly-fp16.safetensors)'
    )
...
if __name__ == "__main__":
    ...
    if generator.test_connection():
        ...
        if result.status == GenerationStatus.COMPLETED:
            ...
            if not args.no_save:
                # Save to centralized asset management system
                saved_paths = generator.save_images(result)
                print(f"📁 Images saved to centralized asset management system:")
